//! Structure API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the Structure CRUD API endpoints.
...
// ============================================================================
// STRUCTURE TEST DATA GENERATOR
// ============================================================================

/// Test data generator for Structure
pub struct StructureTestData;

impl TestDataGenerator for StructureTestData {
...
/// Structure API test suite
pub struct StructureApiTest {
    inner: GenericCrudTest<StructureTestData>,
}

impl StructureApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/structures", "Structure");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, StructureTestData),
        }
    }
...
impl Default for StructureApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    #[tokio::test]
    async fn test_structure_crud() {
        let mut test = StructureApiTest::new();
...
// <<< CUSTOM TESTS START >>>
// Add Structure specific tests here
// <<< CUSTOM TESTS END >>>
