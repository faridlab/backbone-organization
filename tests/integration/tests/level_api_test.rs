...
//!
//! Tests the Level CRUD API endpoints.
...
// ============================================================================
// LEVEL TEST DATA GENERATOR
// ============================================================================

/// Test data generator for Level
pub struct LevelTestData;

impl TestDataGenerator for LevelTestData {
...
/// Level API test suite
pub struct LevelApiTest {
    inner: GenericCrudTest<LevelTestData>,
}

impl LevelApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/levels", "Level");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, LevelTestData),
        }
    }
...
mod tests {
    ...
    #[tokio::test]
    async fn test_level_crud() {
        let mut test = LevelApiTest::new();
