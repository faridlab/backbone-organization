...
/// Create stateless routes for the Organization module.
///
...
///
/// ```ignore
/// let module = OrganizationModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::OrganizationModule) -> Router<()> {
    Router::new()
...
pub fn get_routes(module: &crate::OrganizationModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Organization module.
///
...
pub fn create_combined_routes(module: &crate::OrganizationModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Organization module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::OrganizationModule) -> Router<AppState> {
    Router::new()
