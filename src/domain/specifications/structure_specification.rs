//! Specifications for Structure aggregate
//!
...
// Each predicate implements `Specification<Structure>` and can be combined
...
//
// pub struct ActiveStructureSpec;
// impl Specification<Structure> for ActiveStructureSpec {
//     fn is_satisfied_by(&self, e: &Structure) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
