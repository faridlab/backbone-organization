//! Specifications for Department aggregate
//!
...
// Each predicate implements `Specification<Department>` and can be combined
...
//
// pub struct ActiveDepartmentSpec;
// impl Specification<Department> for ActiveDepartmentSpec {
//     fn is_satisfied_by(&self, e: &Department) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
