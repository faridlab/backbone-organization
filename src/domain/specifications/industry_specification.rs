//! Specifications for Industry aggregate
//!
...
// Each predicate implements `Specification<Industry>` and can be combined
...
//
// pub struct ActiveIndustrySpec;
// impl Specification<Industry> for ActiveIndustrySpec {
//     fn is_satisfied_by(&self, e: &Industry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
