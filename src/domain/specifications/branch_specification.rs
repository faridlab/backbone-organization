//! Specifications for Branch aggregate
//!
...
// Each predicate implements `Specification<Branch>` and can be combined
...
//
// pub struct ActiveBranchSpec;
// impl Specification<Branch> for ActiveBranchSpec {
//     fn is_satisfied_by(&self, e: &Branch) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
