//! Specifications for Level aggregate
//!
...
// Each predicate implements `Specification<Level>` and can be combined
...
//
// pub struct ActiveLevelSpec;
// impl Specification<Level> for ActiveLevelSpec {
//     fn is_satisfied_by(&self, e: &Level) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
