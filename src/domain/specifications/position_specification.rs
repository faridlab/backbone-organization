//! Specifications for Position aggregate
//!
...
// Each predicate implements `Specification<Position>` and can be combined
...
//
// pub struct ActivePositionSpec;
// impl Specification<Position> for ActivePositionSpec {
//     fn is_satisfied_by(&self, e: &Position) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
