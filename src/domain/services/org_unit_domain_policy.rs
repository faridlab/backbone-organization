//! Domain policy for OrgUnit aggregate
//!
...
/// Domain policy for OrgUnit — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OrgUnit>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OrgUnitDomainPolicy = PermitAllPolicy<OrgUnit>;
