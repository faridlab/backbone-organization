//! Domain policy for Industry aggregate
//!
...
/// Domain policy for Industry — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Industry>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type IndustryDomainPolicy = PermitAllPolicy<Industry>;
