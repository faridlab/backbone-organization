//! Position DTOs (Data Transfer Objects)
//!
...
/// Request DTO for full update of a Position
///
...
/// Request DTO for partial update of a Position
///
...
/// Paginated list response for Position entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct PositionListResponseDto {
    /// List of items
    pub items: Vec<PositionResponseDto>,
...
impl PositionListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<PositionResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Position> for PositionSummaryDto {
    fn from(entity: Position) -> Self {
...
impl From<CreatePositionDto> for Position {
...
impl backbone_core::FromCreateDto<CreatePositionDto> for Position {
    fn from_create_dto(dto: CreatePositionDto) -> backbone_core::ServiceResult<Self> {
        Ok(Position::from(dto))
    }
}
