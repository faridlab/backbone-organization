//! Level DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new Level
///
...
pub struct CreateLevelDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "order_number")]
...
/// Request DTO for full update of a Level
///
...
/// Request DTO for partial update of a Level
///
...
/// Paginated list response for Level entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct LevelListResponseDto {
    /// List of items
    pub items: Vec<LevelResponseDto>,
...
impl LevelListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<LevelResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Level> for LevelResponseDto {
...
impl From<Level> for LevelSummaryDto {
    fn from(entity: Level) -> Self {
...
impl From<CreateLevelDto> for Level {
...
impl backbone_core::FromCreateDto<CreateLevelDto> for Level {
    fn from_create_dto(dto: CreateLevelDto) -> backbone_core::ServiceResult<Self> {
        Ok(Level::from(dto))
    }
}
